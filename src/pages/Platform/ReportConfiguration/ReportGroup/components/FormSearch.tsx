...
import { ReportCustomGroupParams } from 'api/model/platform/reportConfiguration/reportCustomGroupModel'
...
const FormSearch: React.FC<SearchFormProps> = ({ selectedRows, setDelOpen }) => {
  ...
  const [searchParams, setSearchParams] = useState<ReportCustomGroupParams>({
    id: '',
    name: '',
    url: ''
  })
  ...
  const handleInputChange = useCallback(
    (field: keyof ReportCustomGroupParams) => (event: ChangeEvent<HTMLInputElement>) => {
