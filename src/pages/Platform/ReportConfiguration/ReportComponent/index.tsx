...
import { deleteByIds, find } from 'modules/platform/reportConfiguration/reportCustomComponent'
...
const ReportComponentIndex = () => {
  const dispatch = useDispatch<AppDispatch>()
  const { page, list } = useSelector((state: RootState) => state.ReportCustomComponentSlice)

  const [dialogValue, setDialogValue] = useState<ReportCustomComponentReply>()
...
export default memo(ReportComponentIndex)
