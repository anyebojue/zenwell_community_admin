...
const TableData: React.FC<TableDataProps> = ({
  ...
  const columns: Column<CommunityAnnouncementReply>[] = [
    { key: 'photo', headerName: '编号', align: 'center' },
    { key: 'title', headerName: '发票类型', align: 'center' },
    { key: 'type', headerName: '业主名称', align: 'center' },
    { key: 'createdAt', headerName: '申请人', align: 'center' },
    { key: 'communityId', headerName: '发票名头', align: 'center' },
    { key: 'communityId', headerName: '纳税人识别号', align: 'center' },
    { key: 'communityId', headerName: '地址', align: 'center', renderCell: () => community.name },
    { key: 'communityId', headerName: '电话', align: 'center', renderCell: () => community.name },
    { key: 'communityId', headerName: '申请金额', align: 'center' },
    { key: 'communityId', headerName: '发票号', align: 'center' },
    {
      key: 'communityId',
      headerName: '审核状态',
      align: 'center',
    ...
    { key: 'communityId', headerName: '申请时间', align: 'center' },
    {
      key: 'operate',
      headerName: '操作',
      align: 'center',
