...
import { deleteByIds, find } from 'modules/property/feeConfig/feeCombo'
...
const FeeComboIndex = () => {
  ...
  const [dialogValue, setDialogValue] = useState<FeeComboReply | undefined>()
    ...
    <Box sx={{ mt: 3.5, width: '100%' }}>
      ...
      <Box sx={contentBoxStyle}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h6">费用套餐</Typography>
          <Button
            size="small"
            variant="contained"
            color="error"
...
export default memo(FeeComboIndex)
