...
import { create, find, update } from 'modules/property/feeConfig/feeCombo'
import {
  Box,
  CircularProgress,
  FormLabel,
...
const FormDialog: React.FC<FormDialogProps> = ({
  ...
  const { page } = useSelector((state: RootState) => state.FeeComboSlice)
  ...
  const [formData, setFormData] = useState<FeeComboParams>(initialFormData)
