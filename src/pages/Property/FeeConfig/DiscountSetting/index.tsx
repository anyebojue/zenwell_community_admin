...
import { deleteByIds, find } from 'modules/property/feeConfig/feeDiscount'
...
const FeeDiscountIndex = () => {
  ...
  const [dialogValue, setDialogValue] = useState<FeeDiscountReply | undefined>()
    ...
    <Box sx={{ mt: 3.5, width: '100%' }}>
      ...
      <Box sx={contentBoxStyle}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h6">折扣信息</Typography>
          <Button
            size="small"
            variant="contained"
            color="error"
