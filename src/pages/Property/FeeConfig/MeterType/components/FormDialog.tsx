...
import { create, find, update } from 'modules/property/feeConfig/meterType'
import {
  Box,
  CircularProgress,
  FormLabel,
...
const FormDialog: React.FC<FormDialogProps> = ({
  ...
  const [formData, setFormData] = useState<MeterTypeParams>(initialFormData)
