...
import { MeterTypeReply } from 'api/model/property/feeConfig/meterTypeModel'
import { deleteByIds, find } from 'modules/property/feeConfig/meterType'
...
const MeterTypeIndex = () => {
  ...
  const [dialogValue, setDialogValue] = useState<MeterTypeReply>()
      ...
      <Box sx={contentBoxStyle}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h6">
            抄表类型(如果一个房屋有多个电表水表 可以在这里新建多个 比如电表1 电表2)
          </Typography>
          <Button
            size="small"
            variant="contained"
