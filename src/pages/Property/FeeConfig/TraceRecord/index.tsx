...
import { deleteByIds, find } from 'modules/property/feeConfig/applyRoomDiscountRecord'
    ...
    <Box sx={{ mt: 3.5, width: '100%' }}>
      ...
      <Box sx={contentBoxStyle}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h6">跟踪记录</Typography>
        ...
        <TableData value={row} setSelectedRows={setSelectedRows} setDelOpen={setDelOpen} />
      </Box>
      <Copyright />
