...
import { create, find, update } from 'modules/property/purchase/storeType'
import {
  Box,
  CircularProgress,
  FormLabel,
...
const FormDialog: React.FC<FormDialogProps> = ({
  ...
  const { page } = useSelector((state: RootState) => state.StoreTypeSlice)
  ...
  const [formData, setFormData] = useState<StoreTypeParams>(initialFormData)
