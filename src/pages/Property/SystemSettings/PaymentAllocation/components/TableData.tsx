...
const TableData: React.FC<TableDataProps> = ({
  ...
  const columns: Column<CommunityReply>[] = [
    ...
    { key: 'nearbyLandmarks', headerName: '支付厂家', align: 'center' },
    { key: 'cityCode', headerName: '支付范围', align: 'center' },
    {
      key: 'state',
      headerName: '状态',
      align: 'center',
    ...
    { key: 'createTime', headerName: '创建时间', align: 'center' },
    { key: 'bId', headerName: '使用说明', align: 'center' },
    {
      key: 'operate',
      headerName: '操作',
      align: 'center',
