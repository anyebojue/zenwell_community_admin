...
const FormSearch: React.FC<SearchFormProps> = () => {
  ...
  const [searchParams, setSearchParams] = useState<ParkingBoxParams>({
    id: '',
    boxName: '',
    tempCarIn: ''
  })
  ...
  const handleInputChange = useCallback(
    (field: keyof ParkingBoxParams) => (event: ChangeEvent<HTMLInputElement>) => {
  ...
  const handleReset = useCallback(() => {
    const initialParams = { id: '', boxName: '', tempCarIn: '' }
      ...
      <Stack direction="row" spacing={3} component="form" sx={{ mt: 2, mb: 1.5 }}>
        ...
        <FormControl sx={{ width: { xs: '100%', md: '25ch' } }} variant="outlined">
          <TextField
            ...
            variant="outlined"
            sx={textFieldStyles}
            value={searchParams.boxName}
            onChange={handleInputChange('boxName')}
          />
        </FormControl>
        <FormControl sx={{ width: { xs: '100%', md: '25ch' } }} variant="outlined">
          <TextField
            ...
            size="small"
            label="请选择临时车进场"
            value={searchParams.tempCarIn}
            onChange={handleSelectChange('tempCarIn')}
            variant="outlined"
            sx={textFieldStyles}
          >
            {[
