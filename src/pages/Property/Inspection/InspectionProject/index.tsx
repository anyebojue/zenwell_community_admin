...
import { deleteByIds, find } from 'modules/property/inspection/spection'
...
const SpectionsIndex = () => {
  const dispatch = useDispatch<AppDispatch>()
  const { page, list } = useSelector((state: RootState) => state.SpectionSlice)
  const [dialogValue, setDialogValue] = useState<SpectionReply>()
...
export default memo(SpectionsIndex)
