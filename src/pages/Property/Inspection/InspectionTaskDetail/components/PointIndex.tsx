...
const PointIndex: React.FC<PointIndexProps> = ({ dialogValue }) => {
    ...
    try {
      const res = await dispatch(
        findPoint({
          'page.num': page.num,
          'page.size': page.size,
          inspectionRouteId: dialogValue.spectionPlan?.spectionRoute?.id
        })
      )
  ...
  }, [dispatch, page.num, page.size, dialogValue.spectionPlan?.spectionRoute?.id])
  ...
  return (
    <>
      ...
      <AddPoint
        ...
        routeDialogValue={dialogValue.spectionPlan?.spectionRoute || {}}
