...
import { ReleaseTypeParams } from 'api/model/property/communitys/releaseTypeModel'
...
const FormSearch: React.FC<SearchFormProps> = ({ selectedRows, setDelOpen }) => {
  ...
  const [searchParams, setSearchParams] = useState<ReleaseTypeParams>({
    typeName: ''
  })

  const handleInputChange =
    (field: keyof ReleaseTypeParams) => (event: ChangeEvent<HTMLInputElement>) => {
