...
const TableData: React.FC<TableDataProps> = () => {
  ...
  const { page, list } = useSelector((state: RootState) => state.QueryNoFeeRoomsSlice)
  ...
  return (
    <DataGrid
      ...
      rows={list}
      columns={[
        { field: 'floorName', headerName: '楼栋', flex: 1 },
        { field: 'unitNum', headerName: '单元', flex: 1 },
        { field: 'roomNum', headerName: '房屋', flex: 1 },
        { field: 'ownerName', headerName: '业主名称', flex: 1 },
