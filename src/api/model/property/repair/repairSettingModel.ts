...
export interface RepairSettingReply {
  ...
  repairWay?: string // 派单方式 100 抢单 200 指派 300 轮训
  communityId?: string // 小区分片ID
  overTimeRule?: string // 超时规则
  statusCd?: number // 数据状态 0 默认
  publicArea?: string // 是否为公共区域 0 否 1 是
  payFeeFlag?: string // 是否收费 1 是 0 否
  priceScope?: string // 收费范围，如30元至50元
  returnVisitFlag?: string // 回访标识 1 都不回访 2 已评价不回访 3 都回访
